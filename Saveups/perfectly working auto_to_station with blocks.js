...
function graph(){
	...
	this.show = function(){
		...
		for(var i = 0 ; i < this.Blocks.length ; i++){
			fill(100,200);
			rect(this.Blocks[i][0]*20,this.Blocks[i][1]*20, 25,25 );
		}
...
// Defining data structure for PRIORITY QUEUE (to be used in dijkstra's Algo. Here, comparator for Nodes is cost.)
